      ...
      <section className="grid items-center gap-12 lg:grid-cols-[1.02fr_0.98fr] lg:gap-16">
        <div>
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            ...
            <Link className="inline-flex items-center justify-center rounded-xl border border-line bg-surface px-5 py-3.5 text-sm font-semibold text-copy transition hover:bg-raised" to="/upload">
              Upload a dataset
            </Link>
          </div>
